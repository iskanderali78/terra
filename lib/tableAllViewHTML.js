...
function makeHeaders(){
    ...
    for(var i = 0; i < tableHeaders.length; i++){
        if(tableHeaders[i] != "Категория"){
            ...
            //headersRow += "<th>";
            headersRow += "<th id='category0' visible=true onclick='change()'>";
            headersRow += tableHeaders[i] +
                "<br><input id='checkCategory' type='checkbox' hidden='true' onclick='filterChange(this)'>";
            headersRow += "</th>\n";
            //headersRow += "<th id='category1' hidden='true' onclick='change(0)'>\n";
            //headersRow += "<select id='categoryType'>\n";
            //for(var n = 0; n < categoryType.length; n++){
            //    headersRow += "<option>";
            //    headersRow += categoryType[n];
            //    headersRow += "</option>\n";
            //}
            //headersRow += "</select>\n";
            //headersRow += "</th>\n";
